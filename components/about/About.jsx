      ...
      <section className="relative px-5 pb-20 pt-32 md:px-10 md:pb-28 md:pt-40">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mx-auto mt-7 max-w-3xl space-y-5 text-sm leading-7 text-[var(--muted)] md:text-base">
            ...
            <p>
              CONCETTO is the annual Techno-Management Fest hosted by
              the Indian Institute of Technology (Indian School of
              Mines), Dhanbad.
            </p>

            <p>
              Bringing together technology, management, innovation and
              creativity, Concetto provides a platform where ideas
              transform into reality and young minds come together to
              build the future.
            </p>

            <p>
              More than just a fest, Concetto is a celebration of
              engineering, imagination and the spirit of innovation.
            </p>
